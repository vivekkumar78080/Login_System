  ...
  <body>
    ...
    <div class="container">
      <div class = "alert alert-success" role = "alert">
        ...
        <p>Hey! how are you ? welcome to MyLoginSystem. You are logged in as <?php echo $_SESSION['email']?></p>
        <hr>
        <p class = "mb-0">Whenever you need, you can Logout <a href = "/loginsystem/logout.php" >Using this link</a></p>
    </div>
    </div>
